  ...
  return (
    <nav className="bg-gray-800 border-b-2">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <ul className="flex text-sm flex-col gap-x-10 p-4 md:px-2 md:py-1  font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-gray-800">
            <li>
              <a
                href="/"
